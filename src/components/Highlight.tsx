...
import { TbArrowBigRightLinesFilled, TbArrowBigDownLinesFilled } from "react-icons/tb"
...
export function Highlight({ icon, title, body }: Props) {
  return (
    <div className="max-w-[368px] w-full h-[200px] md:h-[260px] lg:h-[220px] xl:h-[200px] bg-white rounded shadow-md relative">
      ...
      <TbArrowBigRightLinesFilled className="hidden md:block w-12 h-12 text-main absolute top-4 right-4" />
      <TbArrowBigDownLinesFilled className="block md:hidden w-12 h-12 text-main absolute top-4 right-4" />
